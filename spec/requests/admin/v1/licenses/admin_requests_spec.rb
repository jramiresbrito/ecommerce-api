...
RSpec.describe 'Admin V1 Licenses as :admin', type: :request do
  ...
  context 'GET /games/:game_id/licenses' do
    ...
    context 'without any params' do
      it 'should return 10 Licenses' do
        ...
        expect(json_body['licenses'].count).to eq 10
      end

      it 'should return 10 first Licenses' do
        get url, headers: auth_header(user)
        expected_licenses = licenses[0..9].as_json(only: %i[id key platform status game_id])
        expect(json_body['licenses']).to contain_exactly(*expected_licenses)
      end
    ...
    context 'with search[key] param' do
      ...
      it 'should return only searched licenses limited by default pagination' do
    ...
    context 'with pagination params' do
      ...
      it 'returns records sized by :length' do
        ...
        expect(json_body['licenses'].count).to eq length
      end
  ...
  context 'GET /licenses/:id' do
    ...
    it 'should return the requested license' do
      get url, headers: auth_header(user)
      expected_license = license.as_json(except: %i[created_at updated_at])
      expect(json_body['license']).to eq expected_license
    end
  ...
  context 'POST /games/:game_id/licenses' do
    ...
    context 'valid params' do
      ...
      it 'should add a new license' do
        expect do
          post url, headers: auth_header(user), params: license_params
        end.to change(License, :count).by(1)
      end

      it 'should return the last added license' do
        post url, headers: auth_header(user), params: license_params
    ...
    context 'invalid params' do
      ...
      it "shouldn't add a new License" do
        expect do
  ...
  context 'PATCH /licenses/:id' do
    ...
    context 'invalid params' do
      ...
      it "shouldn't update a license" do
        old_key = license.key
